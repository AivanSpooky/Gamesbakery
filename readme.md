...
- Просмотр каталога игр с фильтрами по категориям (жанрам), названию и цене.
- Оформление заказов, включая покупку нескольких ключей разных игр.
- Передача купленных ключей другим пользователям.
- Добавление отзывов и рейтингов (комментарии + звёздная оценка) к играм.
- Управление данными о играх, ключах, продавцах и заказах.
...
- Продавец (Seller) — выпускает ключи в системе, может редактировать описание своих проектов (в реальной системе — через админку или соглашения с площадкой).
