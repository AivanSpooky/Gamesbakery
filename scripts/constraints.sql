...
GO
ALTER TABLE Users
    ADD CONSTRAINT DF_Users_IsBlocked DEFAULT 0 FOR IsBlocked;
GO
ALTER TABLE Users
...
ALTER TABLE Sellers
    ALTER COLUMN SellerID UNIQUEIDENTIFIER NOT NULL;
GO
ALTER TABLE Sellers
...
GO
ALTER TABLE Sellers
    ADD CONSTRAINT UQ_Sellers_Name UNIQUE (Name);
GO
ALTER TABLE Sellers
    ALTER COLUMN RegistrationDate DATE NOT NULL;
GO
...
ALTER TABLE Games
    ALTER COLUMN GameID UNIQUEIDENTIFIER NOT NULL;
GO
ALTER TABLE Games
...
GO
ALTER TABLE Games
    ADD CONSTRAINT DF_Games_IsForSale DEFAULT 1 FOR IsForSale;
GO
ALTER TABLE Games
...
ALTER TABLE Orders
    ALTER COLUMN OrderID UNIQUEIDENTIFIER NOT NULL;
GO
ALTER TABLE Orders
...
GO
ALTER TABLE Orders
    ADD CONSTRAINT DF_Orders_IsCompleted DEFAULT 0 FOR IsCompleted;
GO
ALTER TABLE Orders
    ALTER COLUMN IsOverdue BIT NOT NULL;
GO
ALTER TABLE Orders
    ADD CONSTRAINT DF_Orders_IsOverdue DEFAULT 0 FOR IsOverdue;
GO
ALTER TABLE Orders
...
ALTER TABLE OrderItems
    ALTER COLUMN OrderItemID UNIQUEIDENTIFIER NOT NULL;
GO
ALTER TABLE OrderItems
...
ALTER TABLE Reviews
    ALTER COLUMN ReviewID UNIQUEIDENTIFIER NOT NULL;
GO
ALTER TABLE Reviews
